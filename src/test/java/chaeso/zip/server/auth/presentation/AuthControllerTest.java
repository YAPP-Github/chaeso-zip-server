...
class AuthControllerTest {
  ...
  @Nested
  @DisplayName("회원가입 이메일 인증 코드")
  class SignupEmailCode {
    ...
    void verifyCode_invalidFormat() throws Exception {
    ...
    void sendCode_duplicate() throws Exception {
      willThrow(new AuthBusinessException(AuthErrorCode.EMAIL_ALREADY_EXISTS))
  ...
  class Login {
    ...
    void accountRegisteredWithGoogle() throws Exception {
      given(authService.login(any(LoginCommand.class)))
  ...
  class Refresh {
    ...
    void reuseDetected() throws Exception {
  ...
  class GoogleAuth {
    ...
    void signupRequired() throws Exception {
      given(authService.googleAuth("id-token")).willReturn(
    ...
    void blankIdToken() throws Exception {
      mockMvc.perform(post("/api/v1/auth/google")
              .contentType(MediaType.APPLICATION_JSON)
  ...
  class SignupGoogle {
    ...
    void blankSignupToken() throws Exception {
