...
public record AudienceMetricResponse(
    ...
    String metricName,
    @Schema(description = "지표 수치값", requiredMode = Schema.RequiredMode.REQUIRED, nullable = true)
    BigDecimal valueNumeric,
    @Schema(description = "지표 텍스트값", requiredMode = Schema.RequiredMode.REQUIRED, nullable = true)
    String valueText,
    @Schema(description = "단위", example = "명", requiredMode = Schema.RequiredMode.REQUIRED, nullable = true)
    String unit,
