...
public enum OnboardingErrorCode implements ErrorCode {
  ...
  CHANNEL_NOT_FOUND(HttpStatus.BAD_REQUEST, "ONB-005", "존재하지 않는 채널입니다."),
  INVALID_AD_PERIOD(HttpStatus.BAD_REQUEST, "ONB-006", "집행 종료일은 시작일보다 빠를 수 없습니다."),
  CONCURRENT_SUBMISSION(HttpStatus.CONFLICT, "ONB-007", "동시에 제출된 요청이 있어 처리할 수 없습니다. 다시 시도해주세요.");
